...
def get_connection() -> Engine:
    ...
    # Use the connection string that works in our test script
    # Create SQLAlchemy engine with direct ODBC connection
    connection_str = f"mssql+pyodbc:///?odbc_connect=DRIVER={{ODBC Driver 17 for SQL Server}};SERVER={server};DATABASE={database};UID={username};PWD={password}"
